...
var createFolderGlobs = function(fileTypePatterns) {
  ...
  var ignore = ['node_modules','bower_components','dist','temp','background.js'];
  var fs = require('fs');
    ...
    copy: {
      main: {
        files: [
          ...
          {src: ['js/**'], dest: 'dist/',filter:'isFile',expand:true},
          {src: ['manifest.json'], dest: 'dist/',filter:'isFile',expand:true},
